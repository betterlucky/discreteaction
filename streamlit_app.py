...
Rewards are set to 100 (Signallers get a reward on receiving an UP response, receivers get a reward on responding UP to HIGH state signallers and DOWN to LOW state signallers), the simulation will run through the grid of signalling costs from min to max.
""")
